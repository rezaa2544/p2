...
### ۷.۳ تأییدِ زنده (`tests/partitioning.js` — ۶۱/۶۱؛ نوبتِ سوم ۴۲ → نوبتِ چهارم ۵۵ → ادامهٔ مانورِ مقیاس ۶۱)
...
### ۹.۲ پنج یافتهٔ مهاجرت که فقط اجرای واقعی آشکار کرد (هر پنج فیکس شد؛ ۱–۳ از استیجینگ ۱.۸M، ۴–۵ از مانورِ ۲۵M)
...
- **پنجرهٔ swap در ۲۵M ≈ ۳۶s** (بدترین خواندن و نوشتن، هر دو): کچ‌آپِ
  ...
  است؛ مسیرِ بهبودِ آینده: پیشیکیتِ chg برای کچ‌آپ (فقط سطرهایِ
  تغییرکرده از شروعِ کپی). ثبت شد؛ امروز تغییر داده نشد.
