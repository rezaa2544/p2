# 🔒 قفل مستندات — DOCS_FREEZE_v1.0.0-rc16 (تاریخی — جایگزین‌شده)

> **⚠️ جایگزین شد:** این قفل با `docs/DOCS_FREEZE_v1.0.0-rc17.md` بامپ شد (2026-09-11، پس از سند درس‌آموخته‌ها). این سند صرفاً تاریخچهٔ فهرست ۲۴۷ سند ریشه در قفل شانزدهم است.

**نسخهٔ قفل:** ۱.۰.۰-rc16 | **تاریخ قفل:** ۲۰۲۶-۰۹-۱۱ | **مالک:** چت ۶ (مستندات و انتشار)
**وضعیت:** این سند نقطهٔ انجماد رسمی کتابخانهٔ مستندات است و جایگزین
`DOCS_FREEZE_v1.0.0-rc1.md` تا `rc15` (تاریخی) می‌شود. فهرست زیر **همهٔ ۲۴۷ سند ریشهٔ**
`docs/*.md` را در لحظهٔ قفل با هش دقیق ثبت می‌کند؛ خود این سند عمداً بیرون فهرست
است (خودارجاعی ممکن نیست) و شمارهٔ ریشه با آن به ۲۴۸ می‌رسد.

**دلیل بامپ:** تدوین بستهٔ خلاصهٔ تصمیم‌گیری برای مدیران ارشد —
`docs/EXECUTIVE_BRIEFING.md` (نه بخش: یک‌صفحه‌ای، سرمایه‌گذاری، راهبری فنی،
ده تصمیم فوری، خط زمانی، کی‌پی‌آی‌ها، ریسک‌های برتر، توصیه، پیوست) و
`docs/EXECUTIVE_SLIDES_OUTLINE.md` (طرح ۱۵ اسلاید برای ارائهٔ ۳۰ دقیقه‌ای) —
مأموریت ۳۳ + همگام‌سازی نقشهٔ مستندات با این قفل. قفل قبلی (`rc15`) به
فهرست اسناد عادی پیوست.
...
1. از این لحظه، **هر تغییر در هر سندِ فهرست‌شده** نیازمند **بامپ نسخه** است
   (rc16 ← rc17؛ نسخهٔ بعد با همین ساختار و فهرست هش تازه ساخته می‌شود و این
...
- همین سند با **کامیت گیت** روی شاخهٔ نشست ثبت می‌شود (دست‌نخورده‌بودن با تاریخچهٔ کامیت
  و باندل تحویل `/home/user/executive-briefing.bundle` قابل اثبات است)؛
...
## ۳) فهرست اسناد ریشه با هش (شمار: ۲۴۷)
...
| `DOCS_HEALTH_REPORT.md` | `sha256:623d443748a7eefd92561e252a9208b5e23e1296f22288b9ea720011fd267e70` |
| `DOCS_INDEX.md` | `sha256:aa8bc32abd2cfe8e24fb5f1838254134e37b31bd170a8631ff9885ffd65ecfdc` |
| `DOCS_METRICS.md` | `sha256:7bf3fa8e12af52b9ddcf0a11fbfd26e784c949ae05da8bab41d988327b681577` |
...
| `DOCUMENTATION_MAP.md` | `sha256:9fd83dc81b05cd2433045d753e415f16677e2260fb67552e7071b3b0a065d23c` |
...
| `TEST_COVERAGE_REPORT.md` | `sha256:22d147f907336d98ba01ede3958e83e33cb7b60d80617962bd30e9d8bbb4356d` |
...
---
_قفل توسط چت ۶ (مستندات و انتشار) در مأموریت ۳۳ بسته شد. راستی‌آزمایی: `node tests/docs-freeze-marker.js`._
