# 🔒 قفل مستندات — DOCS_FREEZE_v1.0.0-rc17 (تاریخی — جایگزین‌شده)

> **⚠️ جایگزین شد:** این قفل با `docs/DOCS_FREEZE_v1.0.0-rc18.md` بامپ شد (2026-09-11، پس از به‌روزرسانی یادداشت انتشار به آرسی۱۷). این سند صرفاً تاریخچهٔ فهرست ۲۴۹ سند ریشه در قفل هفدهم است.

**نسخهٔ قفل:** ۱.۰.۰-rc17 | **تاریخ قفل:** ۲۰۲۶-۰۹-۱۱ | **مالک:** چت ۶ (مستندات و انتشار)
**وضعیت:** این سند نقطهٔ انجماد رسمی کتابخانهٔ مستندات است و جایگزین
`DOCS_FREEZE_v1.0.0-rc1.md` تا `rc16` (تاریخی) می‌شود. فهرست زیر **همهٔ ۲۴۹ سند ریشهٔ**
`docs/*.md` را در لحظهٔ قفل با هش دقیق ثبت می‌کند؛ خود این سند عمداً بیرون فهرست
است (خودارجاعی ممکن نیست) و شمارهٔ ریشه با آن به ۲۵۰ می‌رسد.

**دلیل بامپ:** تدوین سند درس‌آموخته‌ها و بازنگری پروژه —
`docs/LESSONS_LEARNED.md` (ده بخش: خلاصهٔ مدیریتی، درس‌های فنی/فرآیندی/محیطی،
چه‌چیز متفاوت، الگوهای بازمصرف، ضدالگوها، سنجه‌های سفر، توصیه‌ها برای تیم بعدی،
سخن پایانی با امضای هفت هم‌تیمی) — مأموریت ۳۴ + همگام‌سازی نقشهٔ مستندات
(نسخهٔ ۱.۰.۲: نقش «تیم آینده»، بازتولید حرارتی/کلیدواژه/قطب‌ها) و بازیابی وضعیت
شاخه پس از ریست سندباکس. قفل قبلی (`rc16`) به فهرست اسناد عادی پیوست.
...
1. از این لحظه، **هر تغییر در هر سندِ فهرست‌شده** نیازمند **بامپ نسخه** است
   (rc17 ← rc18؛ نسخهٔ بعد با همین ساختار و فهرست هش تازه ساخته می‌شود و این
...
- همین سند با **کامیت گیت** روی شاخهٔ نشست ثبت می‌شود (دست‌نخورده‌بودن با تاریخچهٔ کامیت
  و باندل تحویل `/home/user/lessons-learned.bundle` قابل اثبات است)؛
...
## ۳) فهرست اسناد ریشه با هش (شمار: ۲۴۹)
...
| `DOCS_CONSISTENCY_REPORT.md` | `sha256:2995e455017dab8093e44121e581f4cc3b8b7248b0c36cbb21d6bfa087380ddc` |
...
| `DOCS_HEALTH_REPORT.md` | `sha256:1da6d4997b785a014655d8bf534a6e0a2db4c5007c31c82be89377a6c7a8e964` |
| `DOCS_INDEX.md` | `sha256:542fb42057f7f4d99888b13d656ebfb8b77c5d644b1ce22f97fa4b24158607ca` |
| `DOCS_METRICS.md` | `sha256:d08d6d36fe20bd2a21d7147473b87d92ed6954ebd5b0672854c88f9d59f6a17f` |
...
| `DOCUMENTATION_MAP.md` | `sha256:adf0751bcfc088958ca2ef7adb28bed03c91115d49013f0f3c48e1d8a4f176df` |
...
| `GO_LIVE_PACKAGE.md` | `sha256:ad7c35ee02cb0467b51cbd1574b3a5c457d49fd3026bb79855b3bae3d9ab2972` |
...
| `OPERATIONAL_HANDOVER.md` | `sha256:a165624e26ff426c3ca6b9eef5272b9946c8fc897c187fe7e646d37b6108809d` |
...
| `PEN_TEST_CHECKLIST.md` | `sha256:30ba0350a9e0d663da93479e95b9889b777fa063f0bb66bcedafde4e94b134eb` |
...
| `PILOT_ROLLOUT_PLAN.md` | `sha256:bd690bf6183c6b6bc81e6b1f2ce36051821f043c2b22ff065d42d01887637744` |
...
| `RELEASE_NOTES.md` | `sha256:b273e5758a8ee01167924cfe70f53dfced46e7428256dfdde1ebe3c7f0f84068` |
...
| `SECRETS_MANAGEMENT.md` | `sha256:9e06de1f6c78a369824ad935d475ee726ce8892e90fe86bc08c47e3af24634e3` |
...
| `TEST_COVERAGE_REPORT.md` | `sha256:fa091c02c1c5a8ee4014943619a0c81d989b7349e6ecc6403816d59b57da4537` |
...
---
_قفل توسط چت ۶ (مستندات و انتشار) در مأموریت ۳۴ بسته شد. راستی‌آزمایی: `node tests/docs-freeze-marker.js`._
