...
| سندِ ویرایش‌شده | ۷ | ‏`BUG_HUNT_REPORT.md` · `SECURITY_FINDINGS_REGISTER.md` (نشست ۹) · `A11Y_GUIDE.md` · `A11Y_RUNTIME_REPORT.md` · `NATIONAL_ROADMAP_PROGRESS.md` (مرجِ #۷۷) · `DISASTER_RECOVERY.md` · `DR_RUNBOOK.md` (مرجِ #۷۸) |
