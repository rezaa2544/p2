...
**PR:** [#88](https://github.com/rezaa2544/p2/pull/88) — باز
**وضعیت:** پیاده‌سازی کامل ✅ · گیت‌های محلی همه سبز ✅ · CI مسدودِ **بیلینگ گیت‌هاب** 🔴 (خارج از کنترل کد)
...
1. صاحب مخزن بیلینگ را درست کند → rerun چک‌های PR #88.
2. پس از سبز شدن CI → merge به `main` → به‌روزرسانی ردیف Wave 23 به ✅ در
   `NATIONAL_ROADMAP_PROGRESS.md` (الان 🟡 «آمادهٔ PR» است).
