...
کوئری** تکرار شد. Indexها با `migrations/004_wave3_query_indexes.down.sql`
...
- **🔴 گیتِ برابریِ بایت‌به‌بایتِ مسیرِ JS و مسیرِ SQL** — یعنی اجرای هم‌زمان
  هر دو روی یک ورودی و مقایسهٔ خروجی. آنچه الان سنجیده می‌شود *پیمایشِ
  کامل* و *عدمِ نشتِ دامنه* است، **نه** برابریِ فیلد‌به‌فیلد با مسیرِ JS.
  تا وقتی PG در تولید روشن شود این گیت لازم است.
