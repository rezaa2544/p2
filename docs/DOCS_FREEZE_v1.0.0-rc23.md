# 🔒 قفل مستندات — DOCS_FREEZE_v1.0.0-rc23 (تاریخی — جایگزین‌شده)

> **⚠️ جایگزین شد:** این قفل با `docs/DOCS_FREEZE_v1.0.0-rc24.md` بامپ شد (2026-09-11، پس از پلی‌بوک نجات کامیت‌های پوش‌نشده). این سند صرفاً تاریخچهٔ فهرست ۲۶۰ سند ریشه در قفل بیست‌وسوم است.

**نسخهٔ قفل:** ۱.۰.۰-rc23 | **تاریخ قفل:** ۲۰۲۶-۰۹-۱۱ | **مالک:** چت ۶ (مستندات و انتشار)
**وضعیت:** این سند نقطهٔ انجماد رسمی کتابخانهٔ مستندات است و جایگزین
`DOCS_FREEZE_v1.0.0-rc1.md` تا `rc22` (تاریخی) می‌شود. فهرست زیر **همهٔ ۲۶۰ سند ریشهٔ**
`docs/*.md` را در لحظهٔ قفل با هش دقیق ثبت می‌کند؛ خود این سند عمداً بیرون فهرست
است (خودارجاعی ممکن نیست) و شمارهٔ ریشه با آن به ۲۶۱ می‌رسد.

**دلیل بامپ:** بستن شکاف «تازه‌وارد با ۲۸۰ سند نمی‌داند از کجا شروع کند» —
`docs/MASTER_ONBOARDING_PATH.md` (هشت بخش: مسیرهای ۱ روزه/۱ هفته‌ای/۱ ماهه،
مسیرهای تخصصی پنج‌گانه، چک‌لیست درک با ۵۰ سؤال، مسیرهای اشتباه رایج و منابع
کمکی) + تست پوشش آن — مأموریت ۴۰.
**قید بازیابی:** پس از ریست سندباکس، تاریخچهٔ کامیت از پایه بازسازی شد؛ این قفل
فهرست دیسک را در لحظهٔ بازیابی ثبت می‌کند و زنجیرهٔ اعتماد با باندل تحویل برقرار است.
قفل قبلی (`rc22`) به فهرست اسناد عادی پیوست.
...
1. از این لحظه، **هر تغییر در هر سندِ فهرست‌شده** نیازمند **بامپ نسخه** است
   (rc23 ← rc24؛ نسخهٔ بعد با همین ساختار و فهرست هش تازه ساخته می‌شود و این
...
- همین سند با **کامیت گیت** روی شاخهٔ نشست ثبت می‌شود (دست‌نخورده‌بودن با تاریخچهٔ کامیت
  و باندل تحویل `/home/user/master-onboarding.bundle` قابل اثبات است)؛
...
## ۳) فهرست اسناد ریشه با هش (شمار: ۲۶۰)
...
| `DOCS_HEALTH_REPORT.md` | `sha256:3c846c05c279796f616bc2ea3c4b11c7270b10f5b40171e2353d130edbd4ab01` |
| `DOCS_INDEX.md` | `sha256:98a902cdb926d8209e72b0adc91be9db100c95e7a71c34a84f5237b54c456b3d` |
| `DOCS_METRICS.md` | `sha256:4424499b47b4202a37086b9a9b23deca44de488ad897f4540a59090607822350` |
...
| `DOCUMENTATION_MAP.md` | `sha256:48f8c82bd314421e30895df5ef152640e8839dc99532b0960a19aeff0b4fb222` |
...
| `TEST_COVERAGE_REPORT.md` | `sha256:cf0d79b9f8ac39f038055d62168a6c8a39f8a064e1aed0261a3e64188d7b5849` |
...
---
_قفل توسط چت ۶ (مستندات و انتشار) در مأموریت ۴۰ بسته شد. راستی‌آزمایی: `node tests/docs-freeze-marker.js`._
