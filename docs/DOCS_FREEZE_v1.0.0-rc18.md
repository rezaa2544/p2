# 🔒 قفل مستندات — DOCS_FREEZE_v1.0.0-rc18 (تاریخی — جایگزین‌شده)

> **⚠️ جایگزین شد:** این قفل با `docs/DOCS_FREEZE_v1.0.0-rc19.md` بامپ شد (2026-09-11، پس از مشخصات اوپن‌ای‌پی‌آی و مرجع ای‌پی‌آی). این سند صرفاً تاریخچهٔ فهرست ۲۵۰ سند ریشه در قفل هجدهم است.

**نسخهٔ قفل:** ۱.۰.۰-rc18 | **تاریخ قفل:** ۲۰۲۶-۰۹-۱۱ | **مالک:** چت ۶ (مستندات و انتشار)
**وضعیت:** این سند نقطهٔ انجماد رسمی کتابخانهٔ مستندات است و جایگزین
`DOCS_FREEZE_v1.0.0-rc1.md` تا `rc17` (تاریخی) می‌شود. فهرست زیر **همهٔ ۲۵۰ سند ریشهٔ**
...
**دلیل بامپ:** به‌روزرسانی یادداشت انتشار به نسخهٔ جاری —
`docs/RELEASE_NOTES.md` از آرسی۱ به وی۱.۰.۰-آرسی۱۷: خلاصهٔ اجرایی تازه،
بخش‌های Added/Changed/Fixed/Security/Documentation، تاریخچهٔ کامل ۱۷ قفل
با مانیفست هر نسخه، یادداشت‌های مهاجرت و مسیر ارتقا، و حفظ دوطرفهٔ متن
آرسی۱ در پیوست — مأموریت ۳۵ + ارجاع نسخهٔ جاری در بستهٔ انتشار و نمایه و
بازنویسی تست پوشش یادداشت (۵۴ چک). قفل قبلی (`rc17`) به فهرست اسناد عادی پیوست.
...
- همین سند با **کامیت گیت** روی شاخهٔ نشست ثبت می‌شود (دست‌نخورده‌بودن با تاریخچهٔ کامیت
  و باندل تحویل `/home/user/release-notes-rc17.bundle` قابل اثبات است)؛
...
## ۳) فهرست اسناد ریشه با هش (شمار: ۲۵۰)
...
| `DOCS_HEALTH_REPORT.md` | `sha256:e5963eaa4b080cee734ae1085a744c640e44c37515e569052db48404d63aa3b0` |
| `DOCS_INDEX.md` | `sha256:dfe3e0967b438fb36cb7313c79d8ad11c2ac5979452e23507b80ce581e4a7484` |
| `DOCS_METRICS.md` | `sha256:750fb671313a73d0f11f1f6b666fc00c5173f4e4338cf17380ef309e57c28fd2` |
...
| `DOCUMENTATION_MAP.md` | `sha256:72d063a8031347567e6d391dd5d528c80185ed725418bc0fc1e3d6875a964813` |
...
| `TEST_COVERAGE_REPORT.md` | `sha256:521342dc89ea6cd953696b5373ae399a2f44178c18d57dd04732a060507d5be0` |
...
---
_قفل توسط چت ۶ (مستندات و انتشار) در مأموریت ۳۵ بسته شد. راستی‌آزمایی: `node tests/docs-freeze-marker.js`._
