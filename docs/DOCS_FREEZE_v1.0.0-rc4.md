# 🔒 قفل مستندات — DOCS_FREEZE_v1.0.0-rc4 (تاریخی — جایگزین‌شده)

> **⚠️ جایگزین شد:** این قفل با `docs/DOCS_FREEZE_v1.0.0-rc5.md` بامپ شد (2026-09-10، پس از گزارش یکپارچگی پس از ریست). این سند صرفاً تاریخچهٔ فهرست ۲۲۳ سند در قفل چهارم است.

**نسخهٔ قفل:** ۱.۰.۰-rc4 | **تاریخ قفل:** ۲۰۲۶-۰۹-۱۰ | **مالک:** چت ۶ (مستندات و انتشار)
**وضعیت:** این سند نقطهٔ انجماد رسمی کتابخانهٔ مستندات است و جایگزین
`DOCS_FREEZE_v1.0.0-rc1.md`، `rc2` و `rc3` (تاریخی) می‌شود. فهرست زیر **همهٔ ۲۲۳ سند**
`docs/*.md` را در لحظهٔ قفل با هش دقیق ثبت می‌کند؛ خود این سند عمداً بیرون فهرست
است (خودارجاعی ممکن نیست) و شمارهٔ کتابخانه با آن به ۲۲۴ می‌رسد.

**دلیل بامپ:** تدوین سند مدیریت رازها (`docs/SECRETS_MANAGEMENT.md` — مأموریت ۲۱،
رفع شکاف ثبت‌شده در بستهٔ انطباق قانونی) + ثبت آن در نمایه و به‌روزرسانی ارجاع‌های
بستهٔ انطباق (هر سه از اسناد فهرست‌شدهٔ این قفل).
...
1. از این لحظه، **هر تغییر در هر سندِ فهرست‌شده** نیازمند **بامپ نسخه** است
   (rc4 ← rc5؛ نسخهٔ بعد با همین ساختار و فهرست هش تازه ساخته می‌شود و این
...
| `DOCS_INDEX.md` | `sha256:c88237af432057c5e400cb9c6b53f0f71b5bfdee7fa9d0ac30511f483021bf0f` |
| `DOCS_METRICS.md` | `sha256:6ade5d67d72bb85da8a08105a65312ab64bde71285ad548cc59e2663e292f685` |
...
**رونوشت:** `docs/SECRETS_MANAGEMENT.md` · `docs/DOCS_METRICS.md` · `docs/DOCS_INDEX.md` ·
`docs/DOCS_FREEZE_v1.0.0-rc3.md` (تاریخی) · `docs/SECURITY_MODEL.md`
