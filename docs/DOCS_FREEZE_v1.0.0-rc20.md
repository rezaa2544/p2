# 🔒 قفل مستندات — DOCS_FREEZE_v1.0.0-rc20 (تاریخی — جایگزین‌شده)

> **⚠️ جایگزین شد:** این قفل با `docs/DOCS_FREEZE_v1.0.0-rc21.md` بامپ شد (2026-09-11، پس از پلی‌بوک عملیات پایلوت). این سند صرفاً تاریخچهٔ فهرست ۲۵۴ سند ریشه در قفل بیستم است.

**نسخهٔ قفل:** ۱.۰.۰-rc20 | **تاریخ قفل:** ۲۰۲۶-۰۹-۱۱ | **مالک:** چت ۶ (مستندات و انتشار)
**وضعیت:** این سند نقطهٔ انجماد رسمی کتابخانهٔ مستندات است و جایگزین
`DOCS_FREEZE_v1.0.0-rc1.md` تا `rc19` (تاریخی) می‌شود. فهرست زیر **همهٔ ۲۵۴ سند ریشهٔ**
`docs/*.md` را در لحظهٔ قفل با هش دقیق ثبت می‌کند؛ خود این سند عمداً بیرون فهرست
است (خودارجاعی ممکن نیست) و شمارهٔ ریشه با آن به ۲۵۵ می‌رسد.

**دلیل بامپ:** بستن شکاف «هیچ سند واحدی برای متغیرهای محیطی و پیکربندی نیست» —
`docs/CONFIGURATION_REFERENCE.md` (۱۲۸ متغیر در ۱۲ دسته، پیش‌فرض/الزامی/مثال،
حالت‌های شکست، چرخش با `_PREV`، ممیزی تغییرات و اشتباه‌های رایج)،
ابزار `tools/config-audit.js` (مغایرت‌یابی کد/سند) و دو تست پوشش — مأموریت ۳۷.
قفل قبلی (`rc19`) به فهرست اسناد عادی پیوست.
...
1. از این لحظه، **هر تغییر در هر سندِ فهرست‌شده** نیازمند **بامپ نسخه** است
   (rc20 ← rc21؛ نسخهٔ بعد با همین ساختار و فهرست هش تازه ساخته می‌شود و این
...
- همین سند با **کامیت گیت** روی شاخهٔ نشست ثبت می‌شود (دست‌نخورده‌بودن با تاریخچهٔ کامیت
  و باندل تحویل `/home/user/config-reference.bundle` قابل اثبات است)؛
...
## ۳) فهرست اسناد ریشه با هش (شمار: ۲۵۴)
...
| `DOCS_INDEX.md` | `sha256:e5646fa3a77bbaa8bf47645814cd3ebbe720e4e2e116e3dfbe9c47b487af3d73` |
| `DOCS_METRICS.md` | `sha256:623065f89daf0d06df63334aef3aa2748ea2139c434d5123977845ec80362708` |
...
| `DOCUMENTATION_MAP.md` | `sha256:e53dcbb0e3fed968e38a4d5c96231de07bf0f6ab7404b34ce7663226cb8e5857` |
...
| `OPERATIONAL_HANDOVER.md` | `sha256:92cc910b9316521a6db7dc2ffd7dce2d131647087ac94d68b7b4cbcde52e0247` |
...
| `TEST_COVERAGE_REPORT.md` | `sha256:e512a3ecf1a8837aee54090bf4b0829c8a26d14f7a3670326f701e37dcf18906` |
...
---
_قفل توسط چت ۶ (مستندات و انتشار) در مأموریت ۳۷ بسته شد. راستی‌آزمایی: `node tests/docs-freeze-marker.js`._
