# 🔒 قفل مستندات — DOCS_FREEZE_v1.0.0-rc22 (تاریخی — جایگزین‌شده)

> **⚠️ جایگزین شد:** این قفل با `docs/DOCS_FREEZE_v1.0.0-rc23.md` بامپ شد (2026-09-11، پس از مسیر جامع آنبوردینگ). این سند صرفاً تاریخچهٔ فهرست ۲۵۸ سند ریشه در قفل بیست‌ودوم است.

**نسخهٔ قفل:** ۱.۰.۰-rc22 | **تاریخ قفل:** ۲۰۲۶-۰۹-۱۱ | **مالک:** چت ۶ (مستندات و انتشار)
**وضعیت:** این سند نقطهٔ انجماد رسمی کتابخانهٔ مستندات است و جایگزین
`DOCS_FREEZE_v1.0.0-rc1.md` تا `rc21` (تاریخی) می‌شود. فهرست زیر **همهٔ ۲۵۸ سند ریشهٔ**
`docs/*.md` را در لحظهٔ قفل با هش دقیق ثبت می‌کند؛ خود این سند عمداً بیرون فهرست
است (خودارجاعی ممکن نیست) و شمارهٔ ریشه با آن به ۲۵۹ می‌رسد.

**دلیل بامپ:** بستن شکاف «هیچ سند ارزیابی وندور وجود ندارد» —
`docs/VENDOR_PLAYBOOK.md` (ده بخش: شش دستهٔ وندور، ماتریس امتیازدهی، آر‌اف‌پی،
چک‌لیست آنبوردینگ، الگوهای یکپارچگی، پایش اس‌ال‌ای، آف‌بوردینگ، ردیاب ریسک و لاگ
تصمیم‌ها) + تست پوشش آن — مأموریت ۳۹.
قفل قبلی (`rc21`) به فهرست اسناد عادی پیوست.
...
1. از این لحظه، **هر تغییر در هر سندِ فهرست‌شده** نیازمند **بامپ نسخه** است
   (rc22 ← rc23؛ نسخهٔ بعد با همین ساختار و فهرست هش تازه ساخته می‌شود و این
...
- همین سند با **کامیت گیت** روی شاخهٔ نشست ثبت می‌شود (دست‌نخورده‌بودن با تاریخچهٔ کامیت
  و باندل تحویل `/home/user/vendor-playbook.bundle` قابل اثبات است)؛
...
## ۳) فهرست اسناد ریشه با هش (شمار: ۲۵۸)
...
| `DOCS_HEALTH_REPORT.md` | `sha256:be6d25717bdc424b10577950af551349be9e515216c8e8a8d91462b7e8bbb192` |
| `DOCS_INDEX.md` | `sha256:111dddcab9b5504d10990e16943f71ac18918ae811ccda626fa52f4c700e320e` |
| `DOCS_METRICS.md` | `sha256:f69700fa32fb0d360ec8b18671479e826c46248c3d898c6ec34a45fb2c9e08fd` |
...
| `DOCUMENTATION_MAP.md` | `sha256:7f7591754e4b3700598ee81745242b1a2587485aaadfa4bae9a63ee6aaeda05a` |
...
| `TEST_COVERAGE_REPORT.md` | `sha256:282677b4c747886caa1812dea1d0215ae0a576834ddb77ef9d4da196f02a516d` |
...
---
_قفل توسط چت ۶ (مستندات و انتشار) در مأموریت ۳۹ بسته شد. راستی‌آزمایی: `node tests/docs-freeze-marker.js`._
