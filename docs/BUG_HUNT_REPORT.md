...
- رگرسیونِ کاملِ پس از رفع‌ها روی همین شاخه اجرا شد و وضعیتِ آن در پیامِ تحویل و ردیفِ رجیستری ثبت است؛ پوش با توکنِ درون‌خطی و تأییدِ `git ls-remote` انجام و در گزارشِ تحویل ذکر می‌شود.
