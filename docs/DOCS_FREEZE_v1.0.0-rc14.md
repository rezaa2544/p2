# 🔒 قفل مستندات — DOCS_FREEZE_v1.0.0-rc14 (تاریخی — جایگزین‌شده)

> **⚠️ جایگزین شد:** این قفل با `docs/DOCS_FREEZE_v1.0.0-rc15.md` بامپ شد (2026-09-11، پس از نقشهٔ مستندات و کاتالوگ متادیتا). این سند صرفاً تاریخچهٔ فهرست ۲۴۲ سند ریشه در قفل چهاردهم است.

**نسخهٔ قفل:** ۱.۰.۰-rc14 | **تاریخ قفل:** ۲۰۲۶-۰۹-۱۱ | **مالک:** چت ۶ (مستندات و انتشار)
**وضعیت:** این سند نقطهٔ انجماد رسمی کتابخانهٔ مستندات است و جایگزین
`DOCS_FREEZE_v1.0.0-rc1.md` تا `rc13` (تاریخی) می‌شود. فهرست زیر **همهٔ ۲۴۲ سند ریشهٔ**
`docs/*.md` را در لحظهٔ قفل با هش دقیق ثبت می‌کند؛ خود این سند عمداً بیرون فهرست
است (خودارجاعی ممکن نیست) و شمارهٔ ریشه با آن به ۲۴۳ می‌رسد.

**دلیل بامپ:** تدوین `docs/DOCUMENTATION_MAINTENANCE.md` (راهنمای نگهداری کتابخانهٔ
۲۵۰+ سندی: اصول، چرخه‌ها، فرآیندهای افزودن/آرشیو/بامپ، نقش‌ها، ابزارها، بدهی
مستنداتی — ده بخش) و `docs/ONBOARDING_CHECKLIST.md` (چک‌لیست عملی چهاربخشی
ورود توسعه‌دهندهٔ جدید — مأموریت ۳۱) + ثبت آن‌ها در نمایه و بستهٔ تحویل؛
قفل قبلی (`rc13`) به فهرست اسناد عادی پیوست.

**زیرپوشه‌های بیرون مانیفست ریشه** (۱۶ سند؛ پوشش ساختاری‌شان را تست‌های پوشش
...
1. از این لحظه، **هر تغییر در هر سندِ فهرست‌شده** نیازمند **بامپ نسخه** است
   (rc14 ← rc15؛ نسخهٔ بعد با همین ساختار و فهرست هش تازه ساخته می‌شود و این
...
- همین سند با **کامیت گیت** روی شاخهٔ نشست ثبت می‌شود (دست‌نخورده‌بودن با تاریخچهٔ کامیت
  و باندل تحویل `/home/user/docs-maintenance.bundle` قابل اثبات است)؛
...
## ۳) فهرست اسناد ریشه با هش (شمار: ۲۴۲)
...
| `DOCS_HEALTH_REPORT.md` | `sha256:24fce6df601fd5a104ab1abaf6262cc2ae113eba024fca58f731ac29b7a511cc` |
| `DOCS_INDEX.md` | `sha256:9ee305e36dffc33e59151a234d4ea9da56a3da4e8fe6b3e26343f618d4c78397` |
| `DOCS_METRICS.md` | `sha256:ad239861edd48ba5a8f397f6a125d6cd1f25c0d88770288426a253d690878d5d` |
| `DOCUMENTATION_HANDOVER.md` | `sha256:ce1cac98fa55fdc36a05d4e6f633ca3bc1aa3ab53a513006183cdb8f322c852f` |
| `DOCUMENTATION_MAINTENANCE.md` | `sha256:816c822a9f16523ceb824f2f189d31f5cb9ac0a3413d3511194053b84dee4d20` |
...
| `PILOT_ROLLOUT_PLAN.md` | `sha256:13f88fe05e1be014ef3bd6b38f1a929af41a8e0b16ba594684f344dd82bdd406` |
...
| `TEST_COVERAGE_REPORT.md` | `sha256:f952d9e84cd986c6240e851e0b2e2d7518a9952cf999b92fc7e8d30ae3aedf7e` |
...
---
_قفل توسط چت ۶ (مستندات و انتشار) در مأموریت ۳۱ بسته شد. راستی‌آزمایی: `node tests/docs-freeze-marker.js`._
