# 🔒 قفل مستندات — DOCS_FREEZE_v1.0.0-rc8 (تاریخی — جایگزین‌شده)

> **⚠️ جایگزین شد:** این قفل با `docs/DOCS_FREEZE_v1.0.0-rc9.md` بامپ شد (2026-09-11، پس از راهنماهای نقش‌محور کاربران نهایی). این سند صرفاً تاریخچهٔ فهرست ۲۳۰ سند ریشه در قفل هشتم است.

**نسخهٔ قفل:** ۱.۰.۰-rc8 | **تاریخ قفل:** ۲۰۲۶-۰۹-۱۱ | **مالک:** چت ۶ (مستندات و انتشار)
**وضعیت:** این سند نقطهٔ انجماد رسمی کتابخانهٔ مستندات است و جایگزین
`DOCS_FREEZE_v1.0.0-rc1.md` تا `rc7` (تاریخی) می‌شود. فهرست زیر **همهٔ ۲۳۰ سند ریشهٔ**
`docs/*.md` را در لحظهٔ قفل با هش دقیق ثبت می‌کند؛ خود این سند عمداً بیرون فهرست
است (خودارجاعی ممکن نیست) و شمارهٔ ریشه با آن به ۲۳۱ می‌رسد.

**دلیل بامپ:** بستهٔ کارت‌های ران‌بورد (مأموریت ۲۵) + ارجاع آن در پلی‌بوک‌ها،
ران‌بورد بازیابی و نمایه؛ قفل قبلی (`rc7`) به فهرست اسناد عادی پیوست.

**پوشهٔ فرعی تازه:** `docs/RUNBOOK_CARDS/` با ۱۱ سند (۱۰ کارت A4 از
`RC-001` تا `RC-010` + فهرست/نقشهٔ تصمیم). این زیرپوشه بیرون قرارداد «سند‌های ریشه»
این مانیفست است؛ پوشش ساختاری آن را `tests/runbook-cards-coverage.js` می‌پاید و
فهرست قطعی‌اش در `docs/RUNBOOK_CARDS/README.md` ثبت شده است:

| سند زیرپوشه | نقش |
|---|---|
| `README.md` | فهرست ۱۰ کارت + نقشهٔ درخت تصمیم |
| `REDIS_REVIVE.md` · `PG_PRIMARY_FAILOVER.md` · `PG_PITR_RESTORE.md` | کارت‌های داده |
| `SERVICE_ROLLBACK.md` · `SESSION_REVOCATION.md` · `JWT_SECRET_ROTATION.md` | کارت‌های استقرار/امنیت |
| `RATE_LIMIT_EMERGENCY.md` · `BACKUP_RESTORE.md` · `DISK_FULL_EMERGENCY.md` · `DDOS_MITIGATION.md` | کارت‌های اضطراری |
...
1. از این لحظه، **هر تغییر در هر سندِ فهرست‌شده** نیازمند **بامپ نسخه** است
   (rc8 ← rc9؛ نسخهٔ بعد با همین ساختار و فهرست هش تازه ساخته می‌شود و این
...
- همین سند با **کامیت گیت** روی شاخهٔ نشست ثبت می‌شود (دست‌نخورده‌بودن با تاریخچهٔ کامیت
  و باندل تحویل `/home/user/runbook-cards.bundle` قابل اثبات است)؛
...
## ۳) فهرست اسناد ریشه با هش (شمار: ۲۳۰)
...
| `DOCS_HEALTH_REPORT.md` | `sha256:153eafc5c1a0a9d72f2b8f5c6e6b8d9294806ff62f8b39680254fc585ba4e797` |
| `DOCS_INDEX.md` | `sha256:d16fabc295ccd718e03e546fbffea425c066fc2a12f18341eacb756c6f5c2c32` |
| `DOCS_METRICS.md` | `sha256:86e2dcc114901517f3f003f1b42416e7de4d98187e1397508c93dff7ff3705b9` |
| `DOCUMENTATION_HANDOVER.md` | `sha256:2dfb428b1bf36ebd03fbf4612ab0d5413afed38ae330e62681297ed9e6fd0551` |
...
| `OPERATIONAL_HANDOVER.md` | `sha256:d4d0546c4f20352edd256ab7bdaf69c27e40f65cd6fd47189ad7db3c0e2523da` |
| `OPINION_2026-09-05_ROADMAP_REVIEW.md` | `sha256:ae4998223e48d65fe3094895bfdc44a70013c8150b7c0389d7bffb6c14ba89bc` |
| `P0_BLOCKER_TRACKER.md` | `sha256:73a6a4cb3ca0d7aeb2acadc322b98ec01f943a02a78f35205f55253e1dbd6ded` |
...
---
_قفل توسط چت ۶ (مستندات و انتشار) در مأموریت ۲۵ بسته شد. راستی‌آزمایی: `node tests/docs-freeze-marker.js`._
