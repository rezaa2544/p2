# 🔒 قفل مستندات — DOCS_FREEZE_v1.0.0-rc3 (تاریخی — جایگزین‌شده)

> **⚠️ جایگزین شد:** این قفل با `docs/DOCS_FREEZE_v1.0.0-rc4.md` بامپ شد (2026-09-10، پس از تدوین سند مدیریت رازها). این سند صرفاً تاریخچهٔ فهرست ۲۲۱ سند در قفل سوم است.

**نسخهٔ قفل:** ۱.۰.۰-rc3 | **تاریخ قفل:** ۲۰۲۶-۰۹-۱۰ | **مالک:** چت ۶ (مستندات و انتشار)
**وضعیت:** این سند نقطهٔ انجماد رسمی کتابخانهٔ مستندات است و جایگزین
`DOCS_FREEZE_v1.0.0-rc1.md` و `DOCS_FREEZE_v1.0.0-rc2.md` (تاریخی) می‌شود. فهرست زیر
**همهٔ ۲۲۱ سند** `docs/*.md` را در لحظهٔ قفل با هش دقیق ثبت می‌کند؛ خود این سند
عمداً بیرون فهرست است (خودارجاعی ممکن نیست) و شمارهٔ کتابخانه با آن به ۲۲۲ می‌رسد.

**دلیل بامپ:** تدوین بستهٔ انطباق قانونی و کسب‌وکاری ایران
(`docs/IRAN_COMPLIANCE_PACKAGE.md` — مأموریت ۲۰) + ثبت آن در نمایه و ردیاب پ0
(هر دو از اسناد فهرست‌شدهٔ این قفل).
...
1. از این لحظه، **هر تغییر در هر سندِ فهرست‌شده** نیازمند **بامپ نسخه** است
   (rc3 ← rc4؛ نسخهٔ بعد با همین ساختار و فهرست هش تازه ساخته می‌شود و این
...
قید صادقانه، همانند `rc1`/`rc2`). جایگزین زنجیرهٔ اعتماد:
- همین سند با **کامیت گیت** روی شاخهٔ نشست ثبت می‌شود (دست‌نخورده‌بودن با تاریخچهٔ کامیت
  و باندل تحویل `/home/user/iran-compliance.bundle` قابل اثبات است)؛
- فهرست هش‌های زیر، اثرِ هر سند را به‌تنهایی قابل راستی‌آزمایی می‌کند؛
- گیت‌های لحظهٔ قفل در `docs/DOCS_METRICS.md` ثبت شده‌اند.

## ۳) فهرست اسناد با هش (شمار: ۲۲۱)
...
| `DOCS_HEALTH_REPORT.md` | `sha256:7678cc7b594cf5797b48a621b8ba370eda322f0bd5cbfd9f09196c587586fe38` |
| `DOCS_INDEX.md` | `sha256:985f93ec8f445994fcca02957818c3619398c0a7c4bd9e023c321d7e432b459d` |
| `DOCS_METRICS.md` | `sha256:7f0675849d2c94ab4d20053cba07aabd2f45dbe290cffa65cfc522ff623de4ae` |
| `DOCUMENTATION_HANDOVER.md` | `sha256:f6d9617461064aeebe6e8bae1be316dcc5d8b5477ca60c70a25c1f8d5281d7d8` |
...
| `IRAN_COMPLIANCE_PACKAGE.md` | `sha256:db8277d5ac8d1b9f06d7f1eb6323a0c270656157d77d1d89ea1901d0f9c3c224` |
...
**رونوشت:** `docs/IRAN_COMPLIANCE_PACKAGE.md` (بستهٔ انطباق) · `docs/DOCS_METRICS.md` ·
`docs/DOCS_INDEX.md` · `docs/DOCS_FREEZE_v1.0.0-rc2.md` (تاریخی) · `docs/GO_LIVE_PACKAGE.md`
