...
| چت ۸ (دور ۷) | `chat8-docs-r7.bundle` | `/home/user/chat8-deliverable/chat8-docs-r7.bundle` | `docs/chat8-r5-2026-09-13` | ۱ — گزارش دور ۵/۶ (کامیت پوش‌نشده) | `2a44d48` | `23bf513` (main) | ۵۷٬۹۲۷٬۹۸۴ بایت | ✅ تأییدشده (`bundle verify` = complete history) · `sha256=92fca562…c9f70` · پوش **BLOCKED** (GH_TOKEN در شلِ پس از ریست نیست) · رأس = کامیتِ پیش از کامیتِ همین ردیف (رجیستری خودارجاع نمی‌شود) · بازیابی: `git fetch /home/user/chat8-deliverable/chat8-docs-r7.bundle docs/chat8-r5-2026-09-13` |
