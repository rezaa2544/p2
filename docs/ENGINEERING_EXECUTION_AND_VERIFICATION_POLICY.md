...
**نسخه:** ۱.۰.۰ | **تاریخ:** ۲۰۲۶-۰۹-۲۱ | **مالک:** حاکمیت مهندسی مخزن `rezaa2544/p2`  
...
## ۲. قوانین ۱۴گانه اعتبارسنجی مهندسی (The 14 Execution Rules)
...
مشکلات مربوط به رازهای خارجی، سرویس‌های خارج از کد، تنظیمات سازمان گیت‌هاب و زیرساخت‌های فیزیکی تولید نباید دور زده یا بای‌پاس شوند. این موارد باید با پرچم `EXTERNAL BLOCKER` یا `OWNER DECISION REQUIRED` ثبت گردند.
