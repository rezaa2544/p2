# 🔒 قفل مستندات — DOCS_FREEZE_v1.0.0-rc25 (تاریخی — جایگزین‌شده)

> **⚠️ جایگزین شد:** این قفل با `docs/DOCS_FREEZE_v1.0.0-rc26.md` بامپ شد (2026-09-11، پس از راهنمای بازیابی باندل جامع). این سند صرفاً تاریخچهٔ فهرست ۲۶۴ سند ریشه در قفل بیست‌وپنجم است.

**نسخهٔ قفل:** ۱.۰.۰-rc25 | **تاریخ قفل:** ۲۰۲۶-۰۹-۱۱ | **مالک:** چت ۶ (مستندات و انتشار)
**وضعیت:** این سند نقطهٔ انجماد رسمی کتابخانهٔ مستندات است و جایگزین
`DOCS_FREEZE_v1.0.0-rc1.md` تا `rc24` (تاریخی) می‌شود. فهرست زیر **همهٔ ۲۶۴ سند ریشهٔ**
`docs/*.md` را در لحظهٔ قفل با هش دقیق ثبت می‌کند؛ خود این سند عمداً بیرون فهرست
است (خودارجاعی ممکن نیست) و شمارهٔ ریشه با آن به ۲۶۵ می‌رسد.

**دلیل بامپ:** بستن شکاف «۱۶+ باندل در ۷ سندباکس مرکز پیگیری واحد ندارند» —
`docs/BUNDLE_REGISTRY.md` (شش بخش: جدول مرکزی ۲۵ ردیفهٔ همهٔ باندل‌های شناخته‌شده،
پروتکل راستی‌آزمایی پنج‌گامی، دستور بازیابی در نشست جدید، ریسک/اولویت و قواعد
نگهداری رجیستری) + تست پوشش آن — مأموریت ۴۲.
**قید بازیابی:** این قفل پس از دومین ریست سندباکس در همین روز ساخته شد؛ کامیت بازیابی
مأموریت‌های پیشین در تاریخچهٔ تازه ثبت است و زنجیرهٔ اعتماد با باندل تحویل برقرار می‌ماند.
قفل قبلی (`rc24`) به فهرست اسناد عادی پیوست.
...
1. از این لحظه، **هر تغییر در هر سندِ فهرست‌شده** نیازمند **بامپ نسخه** است
   (rc25 ← rc26؛ نسخهٔ بعد با همین ساختار و فهرست هش تازه ساخته می‌شود و این
...
- همین سند با **کامیت گیت** روی شاخهٔ نشست ثبت می‌شود (دست‌نخورده‌بودن با تاریخچهٔ کامیت
  و باندل تحویل `/home/user/bundle-registry.bundle` قابل اثبات است)؛
...
## ۳) فهرست اسناد ریشه با هش (شمار: ۲۶۴)
...
| `BUNDLE_REGISTRY.md` | `sha256:dc5d55c05033f2c213bc87f7be935efde3a9c1db1a47cb51de0cdb90d8a98456` |
...
| `DOCS_HEALTH_REPORT.md` | `sha256:1ffb58a6420ae1a947cdb7c257e737ca8c806cb9ee25bbd8ffe4518a8b83cad5` |
| `DOCS_INDEX.md` | `sha256:1e370da502f6c2ee56cdbbcc3a5a1ec8638bdf748cca81964cdd65ad15369560` |
| `DOCS_METRICS.md` | `sha256:11977a95604635fc99776156ffae08411325f2864a8c44ee2693d41e95279017` |
...
| `DOCUMENTATION_MAP.md` | `sha256:00e8add84b761d8f019879d987aa573e3d2884d65cddec9878746137269e2f1f` |
...
| `PUSH_RECOVERY_PLAYBOOK.md` | `sha256:c0a4b1dfae727cb7e48afc227aaaa20b368fb9e9a799af8771706170166dfa2a` |
...
| `TEST_COVERAGE_REPORT.md` | `sha256:74ac71a5dd0e62e4ff0a83585a345182909bfad738d60a4ce9b040c1830319be` |
...
---
_قفل توسط چت ۶ (مستندات و انتشار) در مأموریت ۴۲ بسته شد. راستی‌آزمایی: `node tests/docs-freeze-marker.js`._
