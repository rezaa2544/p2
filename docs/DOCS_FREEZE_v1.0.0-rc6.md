# 🔒 قفل مستندات — DOCS_FREEZE_v1.0.0-rc6 (تاریخی — جایگزین‌شده)

> **⚠️ جایگزین شد:** این قفل با `docs/DOCS_FREEZE_v1.0.0-rc7.md` بامپ شد (2026-09-11، پس از گزارش تجمیعی بنچمارک‌های عملکرد). این سند صرفاً تاریخچهٔ فهرست ۲۲۷ سند در قفل ششم است.

**نسخهٔ قفل:** ۱.۰.۰-rc6 | **تاریخ قفل:** ۲۰۲۶-۰۹-۱۱ | **مالک:** چت ۶ (مستندات و انتشار)
**وضعیت:** این سند نقطهٔ انجماد رسمی کتابخانهٔ مستندات است و جایگزین
`DOCS_FREEZE_v1.0.0-rc1.md` تا `rc5` (تاریخی) می‌شود. فهرست زیر **همهٔ ۲۲۷ سند**
`docs/*.md` را در لحظهٔ قفل با هش دقیق ثبت می‌کند؛ خود این سند عمداً بیرون فهرست
است (خودارجاعی ممکن نیست) و شمارهٔ کتابخانه با آن به ۲۲۸ می‌رسد.

**دلیل بامپ:** تدوین `docs/OPERATIONAL_HANDOVER.md` (بستهٔ تحویل عملیاتی ۱۲ بخشی
برای تیم عملیات — مأموریت ۲۳) + ثبت آن در نمایه و سند تحویل مستندات؛ قفل قبلی
(`rc5`) به فهرست اسناد عادی پیوست.
...
1. از این لحظه، **هر تغییر در هر سندِ فهرست‌شده** نیازمند **بامپ نسخه** است
   (rc6 ← rc7؛ نسخهٔ بعد با همین ساختار و فهرست هش تازه ساخته می‌شود و این
...
- همین سند با **کامیت گیت** روی شاخهٔ نشست ثبت می‌شود (دست‌نخورده‌بودن با تاریخچهٔ کامیت
  و باندل تحویل `/home/user/operational-handover.bundle` قابل اثبات است)؛
...
| `DOCS_HEALTH_REPORT.md` | `sha256:fae2e94f06a8eb29541aeb32e83124c678e793b5a24e336f8d0e49824ad2f5fa` |
| `DOCS_INDEX.md` | `sha256:6d35e8bc0f53f11de085a427499d89a8810f7355b7a0ce329c79b03681b88414` |
| `DOCS_METRICS.md` | `sha256:d36b8592a296711fe17cb6d70bbd84e1020e22f114d50ee00ceeedf2df87b9a5` |
...
---
_قفل توسط چت ۶ (مستندات و انتشار) در مأموریت ۲۳ بسته شد. راستی‌آزمایی: `node tests/docs-freeze-marker.js`._
