# 🔒 قفل مستندات — DOCS_FREEZE_v1.0.0-rc2 (تاریخی — جایگزین‌شده)

> **⚠️ جایگزین شد:** این قفل با `docs/DOCS_FREEZE_v1.0.0-rc3.md` بامپ شد (2026-09-10، پس از تدوین بستهٔ انطباق قانونی ایران). این سند صرفاً تاریخچهٔ فهرست ۲۱۹ سند در قفل دوم است.

**نسخهٔ قفل:** ۱.۰.۰-rc2 | **تاریخ قفل:** ۲۰۲۶-۰۹-۱۰ | **مالک:** چت ۶ (مستندات و انتشار)
**وضعیت:** این سند نقطهٔ انجماد رسمی کتابخانهٔ مستندات است و جایگزین
`DOCS_FREEZE_v1.0.0-rc1.md` (تاریخی) می‌شود. فهرست زیر **همهٔ ۲۱۹ سند**
`docs/*.md` را در لحظهٔ قفل با هش دقیق ثبت می‌کند؛ خود این سند عمداً بیرون
فهرست است (خودارجاعی ممکن نیست) و شمارهٔ کتابخانه با آن به ۲۲۰ می‌رسد.

**دلیل بامپ:** ادغام بستهٔ هفت‌گانهٔ پی‌آرها در `main` (#۵۱/#۳۴/#۳۳/#۳۱/#۳۵/#۴۶/#۳۲
@ cd484c3) و ادغام آن در این شاخه: چهار سند ویژگی تازه رسید، اسناد ردیاب/نقشه‌راه/
انتشار/نمایه/دیکشنری به‌روز شدند و `server/schema.sql` جدول `staff_posts` گرفت.
...
1. از این لحظه، **هر تغییر در هر سندِ فهرست‌شده** نیازمند **بامپ نسخه** است
   (rc2 ← rc3؛ نسخهٔ بعد با همین ساختار و فهرست هش تازه ساخته می‌شود و این
...
| `DOCS_HEALTH_REPORT.md` | `sha256:162bff5f725295763a6e14372d9dded5f8943c8d755cfbdf6789ce2e74e21238` |
| `DOCS_INDEX.md` | `sha256:116ac25e017b5f8b67a0b6e992605ecad17146f817f8c178095205657a81fd28` |
| `DOCS_METRICS.md` | `sha256:4169fc5b909195efd81484b0fb9a3118f44c21312a9e9b68599585285d0a6bdf` |
...
| `P0_BLOCKER_TRACKER.md` | `sha256:a288143c5bfc0257f54010394011438dbba7c5fff5bb86c7128d0ee3e6f7fcde` |
...
`docs/DOCS_FREEZE_v1.0.0-rc1.md` (تاریخی) · `docs/RELEASE_NOTES.md` (الحاقیهٔ هفت‌گانه)
