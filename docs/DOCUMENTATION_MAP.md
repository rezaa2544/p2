...
| سنجه | مقدار |
|---|---:|
| کل اسناد (لحظهٔ قفل `rc40`) | **۳۸۱** |
| اسناد ریشهٔ `docs/*.md` (با خود نقشه و قفل) | ۳۲۸ |
| اسناد زیرپوشه‌ها (`RUNBOOK_CARDS/` + `user-guides/` + `pilot/` + `daily-reports/`) | ۵۳ |
