...
| سنجه | مقدار |
|---|---:|
| کل اسناد (لحظهٔ قفل `rc43`) | **۳۸۷** |
| اسناد ریشهٔ `docs/*.md` (با خود نقشه و قفل) | ۳۳۲ |
| اسناد زیرپوشه‌ها (`RUNBOOK_CARDS/` + `user-guides/` + `pilot/` + `daily-reports/`) | ۵۵ |
