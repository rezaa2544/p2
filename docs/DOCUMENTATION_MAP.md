...
| سنجه | مقدار |
|---|---:|
| کل اسناد (لحظهٔ قفل `rc40`) | **۳۶۴** |
| اسناد ریشهٔ `docs/*.md` (با خود نقشه و قفل) | ۳۲۶ |
| اسناد زیرپوشه‌ها (`RUNBOOK_CARDS/` + `user-guides/` + `pilot/` + `daily-reports/`) | ۳۸ |
