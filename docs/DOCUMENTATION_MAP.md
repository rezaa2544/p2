...
| سنجه | مقدار |
|---|---:|
| کل اسناد (لحظهٔ قفل `rc44`) | **۴۶۰** |
| اسناد ریشهٔ `docs/*.md` (با خود نقشه و قفل) | ۴۳۸ |
| اسناد زیرپوشه‌ها (`RUNBOOK_CARDS/` + `user-guides/` + `pilot/` + `GOVERNANCE/` + `roadmaps/`) | ۲۲ |
