# 🔒 قفل مستندات — DOCS_FREEZE_v1.0.0-rc7 (تاریخی — جایگزین‌شده)

> **⚠️ جایگزین شد:** این قفل با `docs/DOCS_FREEZE_v1.0.0-rc8.md` بامپ شد (2026-09-11، پس از بستهٔ کارت‌های ران‌بورد). این سند صرفاً تاریخچهٔ فهرست ۲۲۹ سند در قفل هفتم است.

**نسخهٔ قفل:** ۱.۰.۰-rc7 | **تاریخ قفل:** ۲۰۲۶-۰۹-۱۱ | **مالک:** چت ۶ (مستندات و انتشار)
**وضعیت:** این سند نقطهٔ انجماد رسمی کتابخانهٔ مستندات است و جایگزین
`DOCS_FREEZE_v1.0.0-rc1.md` تا `rc6` (تاریخی) می‌شود. فهرست زیر **همهٔ ۲۲۹ سند**
`docs/*.md` را در لحظهٔ قفل با هش دقیق ثبت می‌کند؛ خود این سند عمداً بیرون فهرست
است (خودارجاعی ممکن نیست) و شمارهٔ کتابخانه با آن به ۲۳۰ می‌رسد.

**دلیل بامپ:** تدوین `docs/PERFORMANCE_BENCHMARKS.md` (گزارش تجمیعی مرجع همهٔ
اعداد عملکردی — مأموریت ۲۴) + ثبت آن در نمایه و ارجاع مدل ظرفیت؛ قفل قبلی
(`rc6`) به فهرست اسناد عادی پیوست.
...
1. از این لحظه، **هر تغییر در هر سندِ فهرست‌شده** نیازمند **بامپ نسخه** است
   (rc7 ← rc8؛ نسخهٔ بعد با همین ساختار و فهرست هش تازه ساخته می‌شود و این
...
- همین سند با **کامیت گیت** روی شاخهٔ نشست ثبت می‌شود (دست‌نخورده‌بودن با تاریخچهٔ کامیت
  و باندل تحویل `/home/user/performance-benchmarks.bundle` قابل اثبات است)؛
...
| `DOCS_HEALTH_REPORT.md` | `sha256:708f9527ae9c34df50827d1227f0f05dd439d702833b2929361ead95a4676ff2` |
| `DOCS_INDEX.md` | `sha256:aa6bf6f968111f0db7932dc79e18fb6a377fcbedcf9d8a2df2a62d3a6c220c06` |
| `DOCS_METRICS.md` | `sha256:ab06b153833f26146831d6de5e4bb7e6365d0849786d22df0b29d288e8a7d537` |
...
---
_قفل توسط چت ۶ (مستندات و انتشار) در مأموریت ۲۴ بسته شد. راستی‌آزمایی: `node tests/docs-freeze-marker.js`._
