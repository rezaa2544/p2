# Arena 8 — DR closure / گزارش نهایی
...
- تاریخ: 2026-09-23. Commit نهایی و دقیقاً آزموده‌شده: `452c7c10eed0274544c71422a772b6448e04a09b`.
- Branch: `arena8/dr-closure-20260923`؛ دو commit محلی: `ad3e9f6` و `452c7c1`.
- Base و آخرین remote main مشاهده‌شده: `5d4a48f7f3cc0bc8ba144c61fb3996e1b458a7f2`؛ [remote probe](evidence/remote-main-final.txt).
...
| Service / round | Measured RTO (s) | ACK-loss window (s) | Recovery-point age at fault (s) | Lost ACK IDs |
|---|---:|---:|---:|---|
| PostgreSQL / 1 | 10.421559 | 0.000000 | 0.031638 | [] |
| PostgreSQL / 2 | 10.309131 | 0.000000 | 0.030507 | [] |
| PostgreSQL / 3 | 10.294930 | 0.000000 | 0.027436 | [] |
| PostgreSQL / 4 | 10.289419 | 0.000000 | 0.037147 | [] |
| PostgreSQL / 5 | 10.305581 | 0.000000 | 0.041903 | [] |
| Redis / 1 | 2.832221 | 0.000000 | 0.004581 | [] |
| Redis / 2 | 2.797025 | 0.000000 | 0.004168 | [] |
| Redis / 3 | 2.466170 | 0.000000 | 0.007831 | [] |
| Redis / 4 | 2.854055 | 0.000000 | 0.005200 | [] |
| Redis / 5 | 2.579450 | 0.000000 | 0.004142 | [] |
...
- هر دو real harness نهایی exit **0** و `failures=[]` دارند؛ 817 ledger records شامل command و assertion است، نه 817 مانور مستقل.
