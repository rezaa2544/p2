# 🔒 قفل مستندات — DOCS_FREEZE_v1.0.0-rc10 (تاریخی — جایگزین‌شده)

> **⚠️ جایگزین شد:** این قفل با `docs/DOCS_FREEZE_v1.0.0-rc11.md` بامپ شد (2026-09-11، پس از ثبت جامع یافته‌های امنیتی). این سند صرفاً تاریخچهٔ فهرست ۲۳۳ سند ریشه در قفل دهم است.

**نسخهٔ قفل:** ۱.۰.۰-rc10 | **تاریخ قفل:** ۲۰۲۶-۰۹-۱۱ | **مالک:** چت ۶ (مستندات و انتشار)
**وضعیت:** این سند نقطهٔ انجماد رسمی کتابخانهٔ مستندات است و جایگزین
`DOCS_FREEZE_v1.0.0-rc1.md` تا `rc9` (تاریخی) می‌شود. فهرست زیر **همهٔ ۲۳۳ سند ریشهٔ**
`docs/*.md` را در لحظهٔ قفل با هش دقیق ثبت می‌کند؛ خود این سند عمداً بیرون فهرست
است (خودارجاعی ممکن نیست) و شمارهٔ ریشه با آن به ۲۳۴ می‌رسد.

**دلیل بامپ:** تدوین `docs/GLOSSARY.md` (واژه‌نامهٔ جامع پروژه: ۹۰ مدخل انگلیسی +
۴۶ فارسی + نقش‌ها/مسیرها/اِس‌اِل‌او/امنیت/معماری — مأموریت ۲۷) + ارجاع آن در
شروع سریع نمایه، آنبوردینگ و پرسش‌وپاسخ؛ قفل قبلی (`rc9`) به فهرست عادی پیوست.
...
1. از این لحظه، **هر تغییر در هر سندِ فهرست‌شده** نیازمند **بامپ نسخه** است
   (rc10 ← rc11؛ نسخهٔ بعد با همین ساختار و فهرست هش تازه ساخته می‌شود و این
...
- همین سند با **کامیت گیت** روی شاخهٔ نشست ثبت می‌شود (دست‌نخورده‌بودن با تاریخچهٔ کامیت
  و باندل تحویل `/home/user/glossary.bundle` قابل اثبات است)؛
...
## ۳) فهرست اسناد ریشه با هش (شمار: ۲۳۳)
...
| `DOCS_HEALTH_REPORT.md` | `sha256:71074993eb588696880d31c2546e4f396f0cf629c6bee1f93c5cc075cb146e54` |
| `DOCS_INDEX.md` | `sha256:39b08ac63caa0ef3667827b06babe84a92bda2693d1bb8bce6cff770ac4ba3cd` |
| `DOCS_METRICS.md` | `sha256:13245c64db1460d31aa6bf884c75998a7667237ef10c54fcaf0bf122265082c7` |
...
---
_قفل توسط چت ۶ (مستندات و انتشار) در مأموریت ۲۷ بسته شد. راستی‌آزمایی: `node tests/docs-freeze-marker.js`._
