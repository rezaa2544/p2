# 🔒 قفل مستندات — DOCS_FREEZE_v1.0.0-rc12 (تاریخی — جایگزین‌شده)

> **⚠️ جایگزین شد:** این قفل با `docs/DOCS_FREEZE_v1.0.0-rc13.md` بامپ شد (2026-09-11، پس از ثبت جامع ریسک‌ها). این سند صرفاً تاریخچهٔ فهرست ۲۳۷ سند ریشه در قفل دوازدهم است.

**نسخهٔ قفل:** ۱.۰.۰-rc12 | **تاریخ قفل:** ۲۰۲۶-۰۹-۱۱ | **مالک:** چت ۶ (مستندات و انتشار)
**وضعیت:** این سند نقطهٔ انجماد رسمی کتابخانهٔ مستندات است و جایگزین
`DOCS_FREEZE_v1.0.0-rc1.md` تا `rc11` (تاریخی) می‌شود. فهرست زیر **همهٔ ۲۳۷ سند ریشهٔ**
`docs/*.md` را در لحظهٔ قفل با هش دقیق ثبت می‌کند؛ خود این سند عمداً بیرون فهرست
است (خودارجاعی ممکن نیست) و شمارهٔ ریشه با آن به ۲۳۸ می‌رسد.

**دلیل بامپ:** تدوین `docs/TEST_COVERAGE_REPORT.md` (جمع‌بندی جامع ۳۴۵ تست در
۱۱ دسته با گیت‌ها و شکاف‌ها — مأموریت ۲۹) + ثبت آن در نمایه؛ قفل قبلی (`rc11`)
...
1. از این لحظه، **هر تغییر در هر سندِ فهرست‌شده** نیازمند **بامپ نسخه** است
   (rc12 ← rc13؛ نسخهٔ بعد با همین ساختار و فهرست هش تازه ساخته می‌شود و این
...
- همین سند با **کامیت گیت** روی شاخهٔ نشست ثبت می‌شود (دست‌نخورده‌بودن با تاریخچهٔ کامیت
  و باندل تحویل `/home/user/test-coverage-report.bundle` قابل اثبات است)؛
...
## ۳) فهرست اسناد ریشه با هش (شمار: ۲۳۷)
...
| `DOCS_HEALTH_REPORT.md` | `sha256:bcb2835545be500f9e2bc42c0882add94c8df34ae8e91609e9ea54304c36b875` |
| `DOCS_INDEX.md` | `sha256:f3e720060a9d9df31e9941a9297cecd03fa04e44216bd21f628bee0a34e2d9f8` |
| `DOCS_METRICS.md` | `sha256:fb607dd9c95f832491c9faa6059cb41106011d553a6864db476663515d160b9d` |
...
| `TEST_COVERAGE_REPORT.md` | `sha256:22ee079dfd2c0c16389268c72a697445da51ba2c1c3ae277771484b6ae441e1f` |
...
---
_قفل توسط چت ۶ (مستندات و انتشار) در مأموریت ۲۹ بسته شد. راستی‌آزمایی: `node tests/docs-freeze-marker.js`._
