# 🔒 قفل مستندات — DOCS_FREEZE_v1.0.0-rc5 (تاریخی — جایگزین‌شده)

> **⚠️ جایگزین شد:** این قفل با `docs/DOCS_FREEZE_v1.0.0-rc6.md` بامپ شد (2026-09-11، پس از بستهٔ تحویل عملیاتی). این سند صرفاً تاریخچهٔ فهرست ۲۲۵ سند در قفل پنجم است.

**نسخهٔ قفل:** ۱.۰.۰-rc5 | **تاریخ قفل:** ۲۰۲۶-۰۹-۱۰ | **مالک:** چت ۶ (مستندات و انتشار)
**وضعیت:** این سند نقطهٔ انجماد رسمی کتابخانهٔ مستندات است و جایگزین
`DOCS_FREEZE_v1.0.0-rc1.md` تا `rc4` (تاریخی) می‌شود. فهرست زیر **همهٔ ۲۲۵ سند**
`docs/*.md` را در لحظهٔ قفل با هش دقیق ثبت می‌کند؛ خود این سند عمداً بیرون فهرست
است (خودارجاعی ممکن نیست) و شمارهٔ کتابخانه با آن به ۲۲۶ می‌رسد.

**دلیل بامپ:** تدوین `docs/POST_RESET_INTEGRITY_REPORT.md` (ممیزی بایت-به-بایت
کتابخانه پس از ریست سندباکس — مأموریت ۲۲) + ثبت آن در نمایه.
...
1. از این لحظه، **هر تغییر در هر سندِ فهرست‌شده** نیازمند **بامپ نسخه** است
   (rc5 ← rc6؛ نسخهٔ بعد با همین ساختار و فهرست هش تازه ساخته می‌شود و این
...
- همین سند با **کامیت گیت** روی شاخهٔ نشست ثبت می‌شود (دست‌نخورده‌بودن با تاریخچهٔ کامیت
  و باندل تحویل `/home/user/post-reset-integrity.bundle` قابل اثبات است)؛
- فهرست هش‌های زیر، اثرِ هر سند را به‌تنهایی قابل راستی‌آزمایی می‌کند؛
- یکپارچگی کامل کتابخانه پس از ریست در `docs/POST_RESET_INTEGRITY_REPORT.md` ممیزی شده است.

## ۳) فهرست اسناد با هش (شمار: ۲۲۵)
...
| `DOCS_HEALTH_REPORT.md` | `sha256:3865a66fe18581595d44a29d25e378cb124541ef0fb91a60a3b212ca65bc418d` |
| `DOCS_INDEX.md` | `sha256:fc0bc85b164084c012acaa3c84bc20c552dbb05b579766fefb9c3aacf13aeafe` |
| `DOCS_METRICS.md` | `sha256:da8caf5d5b2777178cdfdb5f5d460c38ce40fa69618236128d97f846fd2be1f7` |
...
**رونوشت:** `docs/POST_RESET_INTEGRITY_REPORT.md` · `docs/DOCS_METRICS.md` · `docs/DOCS_INDEX.md` ·
`docs/DOCS_FREEZE_v1.0.0-rc4.md` (تاریخی) · `HANDOFF.md` (ثبت حادثهٔ ریست)
