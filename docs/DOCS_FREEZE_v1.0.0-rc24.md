# 🔒 قفل مستندات — DOCS_FREEZE_v1.0.0-rc24 (تاریخی — جایگزین‌شده)

> **⚠️ جایگزین شد:** این قفل با `docs/DOCS_FREEZE_v1.0.0-rc25.md` بامپ شد (2026-09-11، پس از رجیستری مرکزی باندل‌ها). این سند صرفاً تاریخچهٔ فهرست ۲۶۲ سند ریشه در قفل بیست‌وچهارم است.

**نسخهٔ قفل:** ۱.۰.۰-rc24 | **تاریخ قفل:** ۲۰۲۶-۰۹-۱۱ | **مالک:** چت ۶ (مستندات و انتشار)
**وضعیت:** این سند نقطهٔ انجماد رسمی کتابخانهٔ مستندات است و جایگزین
`DOCS_FREEZE_v1.0.0-rc1.md` تا `rc23` (تاریخی) می‌شود. فهرست زیر **همهٔ ۲۶۲ سند ریشهٔ**
`docs/*.md` را در لحظهٔ قفل با هش دقیق ثبت می‌کند؛ خود این سند عمداً بیرون فهرست
است (خودارجاعی ممکن نیست) و شمارهٔ ریشه با آن به ۲۶۳ می‌رسد.

**دلیل بامپ:** بستن شکاف «≈۱۰۰ کامیت پوش‌نشده در سندباکس‌های بسته‌شده سند نجات ندارد» —
`docs/PUSH_RECOVERY_PLAYBOOK.md` (هشت بخش: چرایی قطع پوش، فهرست باندل‌های شناخته‌شده،
دستور پوش در نشست جدید، گیت‌های پیش از مرج، ترتیب مرج، اولویت نجات، حالت‌های شکست
و چک‌لیست نشست نجات) + تست پوشش آن — مأموریت ۴۱.
قفل قبلی (`rc23`) به فهرست اسناد عادی پیوست.
...
1. از این لحظه، **هر تغییر در هر سندِ فهرست‌شده** نیازمند **بامپ نسخه** است
   (rc24 ← rc25؛ نسخهٔ بعد با همین ساختار و فهرست هش تازه ساخته می‌شود و این
...
- همین سند با **کامیت گیت** روی شاخهٔ نشست ثبت می‌شود (دست‌نخورده‌بودن با تاریخچهٔ کامیت
  و باندل تحویل `/home/user/push-recovery.bundle` قابل اثبات است)؛
...
## ۳) فهرست اسناد ریشه با هش (شمار: ۲۶۲)
...
| `DOCS_HEALTH_REPORT.md` | `sha256:24bddd2c8078025616bad684cc4a5deff0eabec90f3314022275b86bb0ac0c92` |
| `DOCS_INDEX.md` | `sha256:e0ca45bbec019574339085bb24db2067ac83efab8e405559b67dd1cd01124e5b` |
| `DOCS_METRICS.md` | `sha256:ef1187785d0c62aebc2e5f2283f2e44f377e372a5e15919e5b51c9ecef1b2032` |
...
| `DOCUMENTATION_MAP.md` | `sha256:ab7a02e053953be1149590265337db90cca14c471e41c5bbbae9818a5f60920d` |
...
| `PUSH_RECOVERY_PLAYBOOK.md` | `sha256:d4f8288b0d6a589d181263a6ac7b21377cc95c5f985f73bcea18c6bb58a6fa2f` |
...
| `TEST_COVERAGE_REPORT.md` | `sha256:32bf14a578ad980f9200fd1c70053ce245c237390835e27a474ab110bd73339f` |
...
---
_قفل توسط چت ۶ (مستندات و انتشار) در مأموریت ۴۱ بسته شد. راستی‌آزمایی: `node tests/docs-freeze-marker.js`._
