# 🔒 قفل مستندات — DOCS_FREEZE_v1.0.0-rc11 (تاریخی — جایگزین‌شده)

> **⚠️ جایگزین شد:** این قفل با `docs/DOCS_FREEZE_v1.0.0-rc12.md` بامپ شد (2026-09-11، پس از گزارش جامع پوشش تست). این سند صرفاً تاریخچهٔ فهرست ۲۳۵ سند ریشه در قفل یازدهم است.

**نسخهٔ قفل:** ۱.۰.۰-rc11 | **تاریخ قفل:** ۲۰۲۶-۰۹-۱۱ | **مالک:** چت ۶ (مستندات و انتشار)
**وضعیت:** این سند نقطهٔ انجماد رسمی کتابخانهٔ مستندات است و جایگزین
`DOCS_FREEZE_v1.0.0-rc1.md` تا `rc10` (تاریخی) می‌شود. فهرست زیر **همهٔ ۲۳۵ سند ریشهٔ**
`docs/*.md` را در لحظهٔ قفل با هش دقیق ثبت می‌کند؛ خود این سند عمداً بیرون فهرست
است (خودارجاعی ممکن نیست) و شمارهٔ ریشه با آن به ۲۳۶ می‌رسد.

**دلیل بامپ:** تدوین `docs/SECURITY_FINDINGS_REGISTER.md` (ثبت جامع ۳۶ یافتهٔ
امنیتی با ریشه/رفع/راستی‌آزمایی — مأموریت ۲۸) + ارجاع آن در دفتر رخدادهای
امنیتی، چک‌لیست پنتست و نمایه؛ قفل قبلی (`rc10`) به فهرست عادی پیوست.
...
1. از این لحظه، **هر تغییر در هر سندِ فهرست‌شده** نیازمند **بامپ نسخه** است
   (rc11 ← rc12؛ نسخهٔ بعد با همین ساختار و فهرست هش تازه ساخته می‌شود و این
...
- همین سند با **کامیت گیت** روی شاخهٔ نشست ثبت می‌شود (دست‌نخورده‌بودن با تاریخچهٔ کامیت
  و باندل تحویل `/home/user/security-register.bundle` قابل اثبات است)؛
...
## ۳) فهرست اسناد ریشه با هش (شمار: ۲۳۵)
...
| `DOCS_HEALTH_REPORT.md` | `sha256:63ab5c24b653897dca95743e316cec361f37d70cbd554446deed1522c71d3f7b` |
| `DOCS_INDEX.md` | `sha256:c01292e9c41aba45c4f55145deaa93a1265f548fec3a171b27c7971367a902c4` |
| `DOCS_METRICS.md` | `sha256:748407b2bc47c235d7bde311ad5324067c55c831dafe64c5f74d417790f473c8` |
...
---
_قفل توسط چت ۶ (مستندات و انتشار) در مأموریت ۲۸ بسته شد. راستی‌آزمایی: `node tests/docs-freeze-marker.js`._
