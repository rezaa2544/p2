# 🔒 قفل مستندات — DOCS_FREEZE_v1.0.0-rc13 (تاریخی — جایگزین‌شده)

> **⚠️ جایگزین شد:** این قفل با `docs/DOCS_FREEZE_v1.0.0-rc14.md` بامپ شد (2026-09-11، پس از راهنمای نگهداری مستندات و چک‌لیست آنبوردینگ). این سند صرفاً تاریخچهٔ فهرست ۲۳۹ سند ریشه در قفل سیزدهم است.

**نسخهٔ قفل:** ۱.۰.۰-rc13 | **تاریخ قفل:** ۲۰۲۶-۰۹-۱۱ | **مالک:** چت ۶ (مستندات و انتشار)
**وضعیت:** این سند نقطهٔ انجماد رسمی کتابخانهٔ مستندات است و جایگزین
`DOCS_FREEZE_v1.0.0-rc1.md` تا `rc12` (تاریخی) می‌شود. فهرست زیر **همهٔ ۲۳۹ سند ریشهٔ**
`docs/*.md` را در لحظهٔ قفل با هش دقیق ثبت می‌کند؛ خود این سند عمداً بیرون فهرست
است (خودارجاعی ممکن نیست) و شمارهٔ ریشه با آن به ۲۴۰ می‌رسد.

**دلیل بامپ:** تدوین `docs/RISK_REGISTER.md` (ثبت جامع ۳۹ ریسک در ۷ دسته با ماتریس
۵×۵، ده‌تای بحرانی، راهبردهای پاسخ و یکپارچگی با رجیسترهای تخصصی — مأموریت ۳۰)
+ ارجاع‌های متقابل در ردیاب پ0/بستهٔ انتشار/هندآف عملیاتی؛ قفل قبلی (`rc12`)
به فهرست اسناد عادی پیوست.
...
1. از این لحظه، **هر تغییر در هر سندِ فهرست‌شده** نیازمند **بامپ نسخه** است
   (rc13 ← rc14؛ نسخهٔ بعد با همین ساختار و فهرست هش تازه ساخته می‌شود و این
...
- همین سند با **کامیت گیت** روی شاخهٔ نشست ثبت می‌شود (دست‌نخورده‌بودن با تاریخچهٔ کامیت
  و باندل تحویل `/home/user/risk-register.bundle` قابل اثبات است)؛
...
## ۳) فهرست اسناد ریشه با هش (شمار: ۲۳۹)
...
| `DOCS_HEALTH_REPORT.md` | `sha256:810a77a14263fcd18f0f6ff67be39e8342d483b25559784407ec9a712cd603ce` |
| `DOCS_INDEX.md` | `sha256:a9c22611cb4cd157f21b3322e67e8d35896cc57b3ed47dc7ebc2131ecb8cdd30` |
| `DOCS_METRICS.md` | `sha256:af3ba3d97157e08d91def6a52c39b6d41572f71eb13b31ae818540160e8db2c4` |
| `DOCUMENTATION_HANDOVER.md` | `sha256:21f0ef74665cce74d97333fea22ed0f1ae56be9235da3140369f3ea0b54e0dc6` |
...
| `TEST_COVERAGE_REPORT.md` | `sha256:8b775a0aa1c036972be460186ea97b73ba2fa06ec8dcef5421e6b2dcda2c965d` |
...
---
_قفل توسط چت ۶ (مستندات و انتشار) در مأموریت ۳۰ بسته شد. راستی‌آزمایی: `node tests/docs-freeze-marker.js`._
