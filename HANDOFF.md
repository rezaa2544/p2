...
- **قدم بعدی:** ساخت کامیت مستقل روی `arena/01a0b00d-p2`، پوش فقط به همین شاخه و تأیید `git ls-remote`; بامپ قفل مستندات و افزودن فایل‌های اسکیلِ غایب، کارهای پیگیری جدا هستند.
