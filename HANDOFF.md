...
- **ابزارِ تازه:** `tools/docs-refs-check.js` — ارجاعِ سند به فایلِ ناموجود را می‌گیرد.
  ...
  ‏`--json`. ‏**۱۱۸ ارجاعِ کهنهٔ تاریخی** در `tools/docs-refs-baseline.json` قفل شد؛
  مسیرهای قالب (`NN-my-feature.js`، ‏`MODULE.js`، ‏`docs/_export/`) با قاعده رد می‌شوند
  نه با خطِ پایه. تستِ خودِ ابزار: `tests/docs-refs-check.js` ‏**۱۹/۱۹**.
...
- **‏`SKILLS_MASTER.md`:** بخشِ **§۵.۲ «تستِ رفتاری به‌جای تستِ متنی»** (پنج قاعده) و
  **§۵.۳ «جغجغه برای بدهیِ تاریخی»** (پنج قاعده).
...
- **گیت‌ها:** ‏`docs-consistency` ۲۲/۲۲ · `docs-freeze-marker` ۱۴/۱۴ · `migration-sequence`
  ۱۹/۱۹ · `docs-refs-check` ۱۹/۱۹ · `a11y-regressions` ۵۴/۵۴ · `smoke` ۵۴۷/۵۴۷ ·
  ‏`build.js --check` سبز · `check-authz` سبز · `secret-scan` ۱۱/۱۱.
