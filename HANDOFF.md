...
## Handoff — دور ۷۸ بند : ماژولِ اسکان/خوابگاه (`has_dorm`) ✅ — ۱۵/۰۶/۱۴۰۵ (2026-09-06)
...
### ۳) چی موند
- بندهای ۸ تا ۱۳ دور ۸ (راهنمایِ پایلوت، مقایسهٔ ذخیره‌گاه، بازبینیِ مستندات/آرشیو/سایمن، گزارشِ پایانی).
