...
## بررسی wave2 — طرح پورت (سند، چت ۳، ۱۹/۰۶) — ✅
- یافتهٔ اصلی: هر ۳ کامیت عملاً روی مین‌اند (W1/W2 یکسان؛ W3 معادلِ تغییرنام‌یافته + اسپلیت
  کامل ۱۳ ماژوله به‌جای پایلوت). فاصله واقعی ۲۱۹ کامیت (نه ۱۴۶). `docs/PORT_WAVE2_PLAN.md`:
  به‌جای پورت، پروتکل راستی‌آزمایی + سطر اختیاری AD ‏۸۵.3‏ + بازنشستگی شاخه. صفر تغییر کد.
