...
- **ابزارِ تازه:** `tools/docs-refs-check.js` — ارجاعِ سند به فایلِ ناموجود را می‌گیرد.
  ...
  ‏`--json`. ‏**۷۹ ارجاعِ کهنهٔ تاریخی** در `tools/docs-refs-baseline.json` قفل شد (۷۱ + ۵ ارجاعِ گزارش‌های نقطه‌درزمانیِ `docs/daily-reports/` که این دور از شاخهٔ PR #100 وارد شد)؛
