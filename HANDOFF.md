...
**وضعیت:** رانِرِ v۲ ساخته و با دو گاردِ تازه؛ رجیسیونِ پایانی روی درختِ تمیز در حالِ اجرا — اعدادِ نهایی در همین ورودی ثبت می‌شود.

- **سرعتِ اندازه‌گیری‌شده (2 vCPU/2GB):** توالی‌ای = ۱۰۰–۱۱۱۵ ثانیه (≈۱۸ دقیقه) · v۱ (پایه @۲-worker، جهش‌ها توالی‌ای) = ۹۳ ثانیه — فازِ جهش هنوز ۸۳٪ِ زمانِ کل (724s از 936s).
...
- **رجیسیونِ پایانی (درختِ تمیز، پس از رفعِ هر دو حادثه):** [در حالِ اجرا — نتیجهٔ نهایی + زمانِ اندازه‌گیری‌شده ثبت می‌شود].
