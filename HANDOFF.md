...
- **رجیسیونِ پایانی (درختِ تمیز، رانِر v۳): **۱۲۵/۱۲۵ سبز در ۴۲۸ ثانیه (≈۷ دقیقه) — در برابرِ ۱۰۵۰–۱۱۱۵ ثانیهٔ توالی‌ای (−۶۰٪)؛ server-mutations 20/20 (لاینِ پورت، بدونِ تنازع). کامیتِ رانِر: همینِ دور (هش در کامیتِ بعد ثبت می‌شود).
