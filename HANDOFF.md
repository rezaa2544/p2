...
**وضعیت:** کامیت `465e9d3` + این داک‌کامیت. گزارش: `R95_SYNC_CONFLICTS_REPORT.md` (ریشه). رجیسیون: **126/127 (982s)** — server15 + server15-mutations سبز؛ قرمزِ تنها (server14-gc-mutations) خطایِ محیطیِ /tmp و تکرارِ تکی سبز بود.
