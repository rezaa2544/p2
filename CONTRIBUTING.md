...
> ۴. **حجم در کمترین حالت** — فایل موقت، بایگانی فشرده و خروجی ساخته‌شده
>    را در مخزن نگذارید. حذف از پوشه کافی نیست؛ اگر در تاریخچهٔ گیت
>    باشد باید با بازنویسی تاریخچه پاک شود.
