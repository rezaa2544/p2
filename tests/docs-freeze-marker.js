...
const FREEZE = 'docs/DOCS_FREEZE_v1.0.0-rc34.md';
...
chk('نسخهٔ وی۱.۰.۰-آرسی۳۴', doc.includes('v1.0.0-rc34') || doc.includes('۱.۰.۰-rc34'));
...
const onDisk = fs.readdirSync(path.join(ROOT, 'docs')).filter((f) => f.endsWith('.md') && f !== 'DOCS_FREEZE_v1.0.0-rc34.md').sort();
...
chk('خود سند قفل در فهرست نیست', !doc.includes('| `DOCS_FREEZE_v1.0.0-rc34.md` | `'));
