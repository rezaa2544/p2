...
const FREEZE = 'docs/DOCS_FREEZE_v1.0.0-rc41.md';
...
chk('نسخهٔ وی۱.۰.۰-آرسی۴۱', doc.includes('v1.0.0-rc41') || doc.includes('۱.۰.۰-rc41'));
...
const onDisk = fs.readdirSync(path.join(ROOT, 'docs')).filter((f) => f.endsWith('.md') && f !== 'DOCS_FREEZE_v1.0.0-rc41.md').sort();
...
chk('خود سند قفل در فهرست نیست', !doc.includes('| `DOCS_FREEZE_v1.0.0-rc41.md` | `'));
