...
const FREEZE = 'docs/DOCS_FREEZE_v1.0.0-rc27.md';
...
chk('نسخهٔ وی۱.۰.۰-آرسی۲۷', doc.includes('v1.0.0-rc27') || doc.includes('۱.۰.۰-rc27'));
...
const onDisk = fs.readdirSync(path.join(ROOT, 'docs')).filter((f) => f.endsWith('.md') && f !== 'DOCS_FREEZE_v1.0.0-rc27.md').sort();
...
chk('خود سند قفل در فهرست نیست', !doc.includes('| `DOCS_FREEZE_v1.0.0-rc27.md` | `'));
