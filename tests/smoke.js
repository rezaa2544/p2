...
const NAV_EXPECT = {
  ...
  manager: ['dashboard','atrisk','growth','calendar','visitors','library','assets','sidadiff','formssms','schoolyear','lifecycle','import','classes','subjects','schedule','bells','users','attendance','grades','discipline','followup','leaves','exams','teachers','corrections','staff','tuition','meetings','notifyqueue','announcements','notifications','chat','busservice'],
