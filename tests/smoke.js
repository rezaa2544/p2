...
const ROUTES = {
  ...
  manager: ['dashboard', 'classes', 'subjects', 'schedule', 'calendar', 'visitors', 'library', 'assets', 'users', 'attendance', 'grades', 'discipline', 'leaves', 'exams', 'teachers', 'corrections', 'tuition', 'announcements', 'notifications', 'chat'],
...
const NAV_EXPECT = {
  ...
  manager: ['dashboard','atrisk','growth','calendar','visitors','library','assets','formssms','schoolyear','lifecycle','import','classes','subjects','schedule','bells','users','attendance','grades','discipline','followup','leaves','exams','teachers','corrections','staff','tuition','meetings','notifyqueue','announcements','notifications','chat','busservice'],
