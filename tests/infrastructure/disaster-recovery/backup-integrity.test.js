...
function runBackupIntegrityTests() {
  ...
  const nominal = verifyBackupIntegrity();
  ...
  const corruptPg = verifyBackupIntegrity({ postgres_verified: false });
  ...
  const corruptRedis = verifyBackupIntegrity({ redis_verified: false });
