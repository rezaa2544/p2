...
document.addEventListener('click',e=>{
  ...
  else if(typeof BUS_ACTIONS!=='undefined'&&BUS_ACTIONS[a]){e.preventDefault();BUS_ACTIONS[a](el,id);}
  else if(typeof VCLASS_ACTIONS!=='undefined'&&VCLASS_ACTIONS[a]){e.preventDefault();VCLASS_ACTIONS[a](el,id);}
  else if(typeof HW_ACTIONS!=='undefined'&&HW_ACTIONS[a]){e.preventDefault();HW_ACTIONS[a](el,id);}
