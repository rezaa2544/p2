...
/* const BUS_ACTIONS — دور 85 (W3 — بند 2.8 بازبینی): اکشن‌های سرویسِ سرویس (دور 77) از A به این ماژولِ خودش منتقل شد. زنجیرهٔ dispatch در 19-actions.js این آبجکت را با (el,id) صدا می‌زند. */
const BUS_ACTIONS={
   'bus-route-new'(el,id){ busRouteModal(null); },

   'bus-route-save'(el,id){
   ...
   'bus-students'(el,id){ busStudentsModal(Number(id)); },

   'bus-students-save'(el,id){
   ...
   'bus-need-set'(el,id){ busNeedModal(Number(id)); },
