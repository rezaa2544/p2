...
function viewFollowup(){
  ...
  h+='<div class="small muted" style="margin-bottom:10px">آستانه‌ها: تأخیر مکرر '+r.late_month+' بار در ماه · غیبت مکرر '+r.absent_month+' بار در ماه · خروج مکرر '+r.exit_week+' بار در هفته. وقتی دانش‌آموزی آستانه را رد کند، او را به مشاور ارجاع دهید — اعلان به ولی **خودکار نیست**؛ پیگیری با مشاور است.</div>';
  if(!flagged.length){
    ...
    h+='<div class="table-wrap"><table class="table"><thead><tr>'
      +'<th>دانش‌آموز</th><th>تأخیر</th><th>غیبت</th><th>روند</th><th>اقدام</th>'
      +'</tr></thead><tbody>';
