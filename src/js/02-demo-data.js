...
function generate(){
  ...
  (function(){
    ...
    /* D.4 — اعلامِ کمبودِ نیرو (نمونهٔ دمو؛ اداره فقط می‌خواند) */
    add('staff_needs',{school_id:1,subject_id:9,count:1,status:'open',note:'دبیرِ فیزیک در مرخصیِ استعلاجی است',created_by:2,created_at:daysAgoISO(12)});
    add('staff_needs',{school_id:1,subject_id:5,count:1,status:'filled',note:'تأمین شد — دبیرِ جدید از نیم‌سال',created_by:2,created_at:daysAgoISO(40),updated_at:daysAgoISO(9)});
    add('staff_needs',{school_id:3,subject_id:255,count:2,status:'open',note:'دو کلاسِ هفتم بدون دبیرِ ریاضی',created_by:492,created_at:daysAgoISO(4)});
    add('staff_needs',{school_id:5,subject_id:334,count:1,status:'open',note:'یک کلاسِ دهم بدون دبیرِ ریاضی',created_by:678,created_at:daysAgoISO(6)});
