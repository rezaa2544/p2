...
# پس از مرج main (2026-09-11): main مهاجرتِ 004_wave3_query_indexes را افزود در حالی که
# 004_wave1_version_seq از پیش وجود داشت ⇒ پنج فایل با چهار شمارهٔ متمایز (۰۰۱–۰۰۴).
# تصادمِ شمارهٔ ۰۰۴ یک قلمِ بازِ به‌ارث‌رسیده از main است (سیاستِ شماره‌گذاریِ پیوستهٔ
# docs/MIGRATION_GUIDE.md نقض شده) — اینجا عمداً به‌عنوان یک واقعیتِ سنجیده پین می‌شود
# تا پنهان نماند؛ تصمیمِ شماره‌گذاریِ مجدد با مالکِ main است.
[ "$MIG" -eq 5 ]; chk "شمار مهاجرت‌های روی دیسک: ۵ فایل (شماره‌های ۰۰۱–۰۰۴)" $? "یافت‌شده: $MIG"
...
has $DOCS/DOCS_INDEX.md "۰۰۱–۰۰۴"; chk "نمایه: فهرست مهاجرت ۰۰۱–۰۰۴" $? "در برابر دیسک"
has $DOCS/RELEASE_NOTES.md "مهاجرت‌های نسخه‌دار ۰۰۱–۰۰۴"; chk "یادداشت انتشار: مهاجرت‌های ۰۰۱–۰۰۴" $? "در برابر دیسک"
