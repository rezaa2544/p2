...
مجموعهٔ جامع و یکپارچهٔ تمام مهارت‌های مهندسی پایش (۲۳ مهارت تخصصی) در دو مسیر همگام:
...
23. **`strict-verification/`** — راستی‌آزمایی چندباره، adversarial، current-head و evidence-first.
